 ...
 */
	function main() {
		//$this->out($this->DbConfig->path);
		Configure::write('Cache.disable', 1);
		//debugger::dump($this->DbConfig->path);
		$this->DbConfig->path = DS . 'Users'. DS . 'VM' . DS . 'Sites' . DS . 'C134' .DS. 'app' . DS . 'config';
 ...
 * @access public
 */
	function newall($newmod='messagoo') {
		//$this->hr();
		//$this->out('Bake All');
		//$this->hr();
		//debugger::dump($this->taskNames);
		...
		//$this->out($this->connection);
		$this->args = array($newmod);
		if (empty($this->args)) {
