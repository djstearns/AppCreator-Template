...
//@interface AlloyAndroidiPhoneNavigationDemoObject : NSObject
//@end

@interface AlloyAndroidiPhoneNavigationDemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AlloyAndroidiPhoneNavigationDemoObject class]])
		{
			for (NSString *key in [[(AlloyAndroidiPhoneNavigationDemoObject*)o modules] allKeys])
			{
