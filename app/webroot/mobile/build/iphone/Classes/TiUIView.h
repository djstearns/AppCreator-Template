...
/**
 Base class for all AlloyAndroidiPhoneNavigationDemo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AlloyAndroidiPhoneNavigationDemo view hierarchy (such as wrapped iOS UIViews) was touched.
