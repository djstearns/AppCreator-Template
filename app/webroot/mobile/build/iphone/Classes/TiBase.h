...
// in simulator we redefine to format for AlloyAndroidiPhoneNavigationDemo Developer console
...
{\
	NSString * exceptionName = [@"org.alloyandroidiphonenavigationdemo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alloyandroidiphonenavigationdemo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAlloyAndroidiPhoneNavigationDemoNativeItemNone = -1, 
	UIAlloyAndroidiPhoneNavigationDemoNativeItemSpinner = -2,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemProgressBar = -3,
	
	UIAlloyAndroidiPhoneNavigationDemoNativeItemSlider = -4,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemSwitch = -5,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemMultiButton = -6,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemSegmented = -7,
	
	UIAlloyAndroidiPhoneNavigationDemoNativeItemTextView = -8,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemTextField = -9,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemSearchBar = -10,
	
	UIAlloyAndroidiPhoneNavigationDemoNativeItemPicker = -11,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemDatePicker = -12,
	
	UIAlloyAndroidiPhoneNavigationDemoNativeItemInfoLight = -13,
	UIAlloyAndroidiPhoneNavigationDemoNativeItemInfoDark = -14,
	
	UIAlloyAndroidiPhoneNavigationDemoNativeItemDisclosure = -15,
	
	UIAlloyAndroidiPhoneNavigationDemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AlloyAndroidiPhoneNavigationDemo instances of
