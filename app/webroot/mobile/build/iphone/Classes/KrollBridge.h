...
@interface AlloyAndroidiPhoneNavigationDemoObject : KrollCoverageObject {
#else
@interface AlloyAndroidiPhoneNavigationDemoObject : KrollObject {
#endif
@private
...
extern NSString * AlloyAndroidiPhoneNavigationDemo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AlloyAndroidiPhoneNavigationDemoObject *_alloyandroidiphonenavigationdemo;
    KrollObject* console;
	BOOL shutdown;
