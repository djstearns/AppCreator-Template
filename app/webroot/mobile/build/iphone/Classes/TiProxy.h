...
//Rare exceptions to indicate a bug in the _alloyandroidiphonenavigationdemo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AlloyAndroidiPhoneNavigationDemo proxies.
 */
