...
function globalopenDetail(_e, Modelname) {
    var things = Alloy.Collections[Modelname];
    var addController = Alloy.createController("detail", {
        parentTab: Alloy.Globals.tabGroup.getActiveTab(),
...
Alloy.Globals.BASEURL = "http://www.derekstearns.com/sampleapp/";
...
Alloy.Globals.RELATIONSHIP = {
    workers: {
        ...
        related: {
            widgets: {
                manytomanytblname: "workers_widgets",
                manytomanyModelname: "WorkersWidgets",
                manytomanymodelname: "workerswidgets"
            }
        }
    },
...
if (true == Alloy.Globals.LocalDB) {
    Alloy.Collections.Widgets = Alloy.createCollection("widget");
    Alloy.Collections.Workers = Alloy.createCollection("worker");
