function Controller() {
    function __alloyId14() {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId12 = Ti.UI.createTableViewRow({
                dataId: "undefined" != typeof __alloyId11.__transform["id"] ? __alloyId11.__transform["id"] : __alloyId11.get("id"),
    ...
    var __alloyId13 = Alloy.Collections["Place"] || Place;
    ...
    __alloyId17.push($.__views.camera);
    ...
    __alloyId17.push($.__views.refresh);
    ...
    __alloyId17.push($.__views.addbtn);
