function Controller() {
    function __alloyId29() {
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId27 = Ti.UI.createTableViewRow({
                dataId: "undefined" != typeof __alloyId26.__transform["id"] ? __alloyId26.__transform["id"] : __alloyId26.get("id"),
                title: "undefined" != typeof __alloyId26.__transform["name"] ? __alloyId26.__transform["name"] : __alloyId26.get("name")
            });
    ...
    var __alloyId28 = Alloy.Collections["Widget"] || Widget;
    ...
    __alloyId32.push($.__views.camera);
    ...
    __alloyId32.push($.__views.refresh);
    ...
    __alloyId32.push($.__views.addbtn);
    ...
    $.__views.tblviewWindow.add($.__views.__alloyId30);
    exports.destroy = function() {
        __alloyId28.off("fetch destroy change add remove reset", __alloyId29);
    };
    _.extend($, $.__views);
    var singlename = "widget";
    var modelname = "widgets";
    var Modelname = "Widget";
    var tblname = "widgets";
    var ManyToManys = [ "related workers", "places", "Cancel" ];
